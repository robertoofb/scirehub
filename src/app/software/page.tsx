  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative w-full h-[400px] bg-black mb-10">
        <img  
          src="https://uiwtngjlfztpkkvirvkb.supabase.co/storage/v1/object/public/hero's/software.jpg?t=2024-12-06T18%3A11%3A36.362Z"
          alt="Software Hero"
        ...
        <div className="absolute top-80 z-10 items-center justify-center h-full pl-6">
          <h1 className="text-4xl font-bold text-white text-start">
             Lista de Artículos de Software
          </h1>
          <p className="text-start font-thin text-white">
          Sumérgete en las tendencias más recientes y las investigaciones 
          de vanguardia en el mundo del desarrollo de software, donde la 
          creatividad y la tecnología se combinan para resolver los retos del futuro digital.
          </p>
        </div>
      </div>
      {/* Contenido principal */}
