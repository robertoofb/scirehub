  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative w-full h-[400px] bg-black mb-10">
        <img  
          src="https://uiwtngjlfztpkkvirvkb.supabase.co/storage/v1/object/public/hero's/administracion.jpg?t=2024-12-06T18%3A10%3A06.914Z"
          alt="Administracion Hero"
        ...
        <div className="absolute top-80 z-10 items-center justify-center h-full pl-6">
          <h1 className="text-4xl font-bold text-white text-start">
             Lista de Artículos de Administración de Empresas
          </h1>
          <p className="text-start font-thin text-white">
          Descubre estudios destacados y estrategias innovadoras en el 
          ámbito de la administración, diseñadas para optimizar recursos y 
          liderar organizaciones hacia el éxito en un entorno competitivo.
          </p>
        </div>
      </div>
      {/* Contenido principal */}
