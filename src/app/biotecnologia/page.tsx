  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative w-full h-[400px] bg-black mb-10">
        <img  
          src="https://uiwtngjlfztpkkvirvkb.supabase.co/storage/v1/object/public/hero's/biotecnologia.jpg?t=2024-12-06T18%3A10%3A54.440Z"
          alt="Biotecnología Hero"
        ...
        <div className="absolute top-80 z-10 items-center justify-center h-full pl-6">
          ...
          <p className="text-start font-thin text-white">
              Explora los avances más recientes y las investigaciones destacadas
              en el fascinante mundo de la Biotecnología, donde la innovación
              transforma la ciencia en soluciones para el futuro.
          </p>
        </div>
      </div>
      {/* Contenido principal */}
